...
--
-- Current Database: `minipro`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `minipro` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `formid` (
  ...
  `created` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9925 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-19 18:06:46
